...
<html>
	...
	<body>
		...
		<div class="login-boxtitle">
			<a href="/"><img alt="logo" src="{{asset('Home/images')}}/logobig.png" /></a>
		</div>
				...
				<div class="login-box">
					...
					<div class="partner">
						...
						<div class="am-btn-group">
							<li>
								<a href="javascript:;"><i class="am-icon-qq am-icon-sm"></i><span>QQ登录</span></a>
							</li>
							<li>
								<a href="javascript:;"><i class="am-icon-weibo am-icon-sm"></i><span>微博登录</span> </a>
							</li>
							<li>
								<a href="javascript:;"><i class="am-icon-weixin am-icon-sm"></i><span>微信登录</span> </a>
							</li>
						</div>
					</div>

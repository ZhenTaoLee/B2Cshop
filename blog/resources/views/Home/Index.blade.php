...
<link href="{{asset('css/Home/css/hmstyle.css')}}" rel="stylesheet" type="text/css" />
<style>
	.clock{display: block;height: 145px;background:url("{{asset('Home/images')}}/clockbg.png") repeat ;position: relative;}
</style>
@endsection
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd><a title="蒸蛋糕" href="#"><span>蒸蛋糕</span></a></dd>
																><a title="马卡龙" href="#"><span>马卡龙</span></a></dd>
															</dl>
															<dl class="dl-sort">
				...
				<div class="marqueen">
					...
					<div class="mod-vip">
						...
						<div class="member-login">
							<center><a class="am-btn-warning btn" href="login.html">注销登录</a></center>

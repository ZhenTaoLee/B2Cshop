		...
		<div class="info-main">
			<form class="am-form am-form-horizontal">
				...
				<div class="am-form-group">
					...
					<div class="am-form-content">
						<p><input style="text" value="asdd" readonly class="email"><button style="submit"><a href="{{url('Home/phoneRevise')}}">修改</a></button></p>
				...
				<div class="am-form-group">
					...
					<div class="am-form-content">
						<p><input style="text" value="asdd" readonly class="email"><button style="submit"><a href="{{url('Home/emailRevise')}}">修改</a></button></p>

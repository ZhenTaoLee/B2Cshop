		...
		<div class="m-user">
			...
			<div class="wallet">
				...
				<p class="m-big squareS">
					<a href="#">
						<i><img src="{{asset('Home/images/shopping.png')}}"/></i>
						<span class="m-title">能购物</span>
					</a>
				</p>
				<p class="m-big squareA">
					<a href="#">
						<i><img src="{{asset('Home/images/safe.png')}}"/></i>
						<span class="m-title">够安全</span>
					</a>
				</p>
				<p class="m-big squareL">
					<a href="#">
						<i><img src="{{asset('Home/images/profit.png')}}"/></i>
		...
		<div class="m-order">
			...
			<div class="orderContentBox">
				<div class="orderContent">
					<div class="orderContentpic">
						<div class="imgBox">
							<a href="orderinfo.html"><img src="{{asset('Home/images/youzi.jpg')}}"></a>
						</div>
					</div>
			...
			<div class="orderContentBox">
				<div class="orderContent">
					<div class="orderContentpic">
						<div class="imgBox">
							<a href="orderinfo.html"><img src="{{asset('Home/images/heart.jpg')}}"></a>
						</div>
					</div>
					<div class="detailContent">
    ...
    <div class="am-tabs-bd">
        ...
        <div data-tab-panel-0 class="am-tab-panel am-active">
    		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
				<ul class="am-slides">
                   <li>
                   	  <a><img class="am-thumbnail" src="{{asset('Home/images/EZA27501.jpg')}}" /></a>
                   	  <strong class="price">¥32.9</strong>
                   </li>
                   <li>
                   	  <a><img class="am-thumbnail" src="{{asset('Home/images/BxJk6.jpg')}}" /></a>
                   	  <strong class="price">¥32.9</strong>
                   </li>
                   <li>
                   	  <a><img class="am-thumbnail" src="{{asset('Home/images/Hxcag60.jpg')}}" /></a>
                   	  <strong class="price">¥32.9</strong>
                   </li>
                   <li>
                   	  <a><img class="am-thumbnail" src="{{asset('Home/images/youzi.jpg')}}" /></a>
                   	  <strong class="price">¥32.9</strong>
                   </li>
                   <li>
                   	  <a><img class="am-thumbnail" src="{{asset('Home/images/EZA27501.jpg')}}" /></a>
